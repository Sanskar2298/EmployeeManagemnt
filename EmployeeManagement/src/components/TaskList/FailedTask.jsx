...
const FailedTask = ({ data }) => {
  return (
    <div className="flex-shrink-0 h-full w-[300px] p-5 bg-yellow-600 rounded-xl text-white">
      ...
      <div className="mt-2">
        <button className="w-full bg-white text-red-600 font-bold py-1 rounded">
          ❌ Failed
        </button>
      </div>
    </div>
